...
main(int argc, char *argv[])
{
    ...
    mod_pid = run_module("../../../src/modules/modbus/daxmodbus", "conf/mb_server_no_holds.conf");
    ...
    /* FC 3 */
    result += _check_response(s, "\x00\x01\x00\x00\x00\x06\x01\x03\x00\x00\x00\x01", 12,
                                 "\x00\x01\x00\x00\x00\x03\x01\x83\x01", 9);
    /* FC 6 */
    result += _check_response(s, "\x00\x07\x00\x00\x00\x06\x01\x06\x00\x00\x00\x01", 12,
                                 "\x00\x07\x00\x00\x00\x03\x01\x86\x01", 9);
    /* FC 16 */
    result += _check_response(s, "\x00\x09\x00\x00\x00\x07\x01\x10\x00\x00\x00\x01\x00\x01", 13,
                                 "\x00\x09\x00\x00\x00\x03\x01\x90\x01", 9);
