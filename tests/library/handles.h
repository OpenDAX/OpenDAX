...
tag_type test5;
    ...
    */
    ...
    /*         Tag          N  B  b  c  s   type */
            ...
            {"HandleTest1.Dint3", 0, 16, 0, 3, 12, "DINT", "HandleTest1.Dint3[0]"},
            ...
            {"HandleTest2[1].Test1", 0, 152, 0, 5, 140, "Test1", "HandleTest2[1].Test1[0]"},
            {"HandleTest2[4].Int3", 3, 584, 0, 3, 6, "INT", "HandleTest2[4].Int3[0]"},
            {"HandleTest2[4].Int3", 0, 584, 0, 3, 6, "INT", "HandleTest2[4].Int3[0]"},

            {"HandleTest2[0].Test1[0].Bool10[4]", 1, 16, 4, 1, 1, "BOOL", NULL},
            {"HandleTest2[0].Test1[0].Bool10", 0, 16, 0, 10, 2, "BOOL", "HandleTest2[0].Test1[0].Bool10[0]"},
            {"HandleTest2[0].Test1[1].Bool10", 0, 44, 0, 10, 2, "BOOL", "HandleTest2[0].Test1[1].Bool10[0]"},
            {"HandleTest2[4].Test1[0].Bool10", 0, 600, 0, 10, 2, "BOOL", "HandleTest2[4].Test1[0].Bool10[0]"},
            {"HandleTest2[1]", 0, 146, 0, 1, 146, "Test2", NULL},

            {"HandleTest4[2].Test1.Bool10", 0, 1580, 0, 10, 2, "BOOL", "HandleTest4[2].Test1.Bool10[0]"},
            {"HandleTest4[2].Test1.Bool10", 10, 1580, 0, 10, 2, "BOOL", "HandleTest4[2].Test1.Bool10[0]"},
