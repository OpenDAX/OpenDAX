...
#define MSG_ADD_OVRD    0x0019 /* Add override data and mask */
#define MSG_DEL_OVRD    0x001A /* Delete override */
#define MSG_GET_OVRD    0x001B /* Read the current override mask and raw value for the given tag */
#define MSG_SET_OVRD    0x001C /* Set or clear tag override flag */
